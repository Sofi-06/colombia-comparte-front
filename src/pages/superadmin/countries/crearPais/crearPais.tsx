...
function CrearPaisPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatusMessage(
        error instanceof Error ? error.message : 'No fue posible crear el pais.',
      )
      setStatusTone('error')
    } finally {
      setIsSaving(false)
        ...
        <div className="notice-form-page">
          <article className="notice-form-card">
            <div className="notice-form-card__header">
              <div>
                <h1>Crear pais</h1>
                <p>Registra el nombre, codigo, slug y estado para habilitarlo en el sistema.</p>
              </div>
